...
<MetaTags
  title="{title}"
  description="Heroicon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-heros.vercel.app/',
    title: "Svelte Heros",
    description: "Heroicon set for Svelte",
    images: [{ url: 'https://open-graph-vercel.vercel.app/api/svelte-heros', width: 1200, height: 630, alt: "Svelte Heros" }],
    site_name: 'Svelte Heros'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: "Svelte Heros",
    description: "Heroicon set for Svelte",
    image:'https://open-graph-vercel.vercel.app/api/svelte-heros',
    imageAlt: "Svelte Heros"
  }} />
...
<header class="flex-none w-full mx-auto bg-white dark:bg-zinc-950">
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-zinc-950 ">
    ...
    <NavUl {hidden} {divClass} {ulClass} on:click={() => setTimeout(toggle, 1)} 
      ...
      <NavLi csolidlass="lg:px-2 lg:mb-0" active={activeUrl === '/solid'} href="/solid">Solid</NavLi>
      <NavLi class="lg:px-2 lg:mb-0" href="https://github.com/shinokada/svelte-heros">GitHub</NavLi>
...
<Footer footerType="logo" class="dark:bg-zinc-950">
  <div class="sm:flex sm:items-center sm:justify-between">
    <FooterBrand
    href="https://svelte-heros.vercel.app/"
    name="Svelte Heros" classSpan="text-primary-700 dark:text-primary-500"
  />
  <FooterLinkGroup ulClass="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
    <FooterLink href="/">Home</FooterLink>
    <FooterLink href="/outline">Outline</FooterLink>
    <FooterLink href="/solid">Solid</FooterLink>
    <FooterLink href="https://github.com/shinokada/svelte-heros/blob/main/LICENSE">Licensing</FooterLink>
    <FooterLink href="https://github.com/shinokada/svelte-heros/">GitHub</FooterLink>
  </FooterLinkGroup>
  </div>
</Footer>
