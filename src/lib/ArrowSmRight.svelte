...
>
  ...
  {#if variation === 'outline'}
    <path d="M13 7L18 12M18 12L13 17M18 12L6 12" stroke="{color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> 
  {:else}
