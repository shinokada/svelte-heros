...
>
  ...
  {#if variation === 'outline'}
    <path d="M11 17L6 12M6 12L11 7M6 12L18 12" stroke="{color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> 
  {:else}
