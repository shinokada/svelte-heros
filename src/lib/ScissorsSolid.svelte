<script>export let size="24"; export let color="currentColor";export let ariaLabel="scissors" </script><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width={size} height={size} class={$$props.class} {...$$restProps} aria-label={ariaLabel} fill={color} >
