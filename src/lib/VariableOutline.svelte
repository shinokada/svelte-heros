<script>export let size="24"; export let color="currentColor";export let ariaLabel="variable" </script><svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} class={$$props.class} {...$$restProps} aria-label={ariaLabel} fill="none" viewBox="0 0 24 24" stroke-width="2" stroke={color} >
