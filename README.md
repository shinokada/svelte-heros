...
See the [Svelte Heros documentation](https://svelte-heros.codewithshin.com/) to learn more.

## Icons

- [Outline](https://svelte-heros.codewithshin.com/outline)
- [Solid](https://svelte-heros.codewithshin.com/solid)
